...
function createEducation(div) {
    div.innerHTML = "<h2>Education</h2>\
        <h5>Master studies [2015. – 2018.]</h5>\
        <h6>School of Electrical Engineering, University of Belgrade</h6>\
        <h6>Computer Engineering and Information Theory</h6>\
        <h5>Bechelor studies [2011. – 2015.]</h5>\
        <h6>School of Electrical Engineering, University of Belgrade</h6>\
        <h6>Computer Engineering and Information Theory</h6>\
        <h5>High School of Electrical Engeneering [2007. – 2011.]</h5>\
        <h6>Computer technician</h6>";
}

function createSkills(div) {
    div.innerHTML = "<h2>Skills</h2>\
...
function createPersonalityAndInterests(div) {
    div.innerHTML = "<h2>Personality and interests</h2>\
        <h6>Passion for quality and performance</h6>\
